...
public interface FeedbackRepository extends JpaRepository<EFeedback, Long> {
    ...
    // Query to get all feedback descriptions for processing keywords in service layer
    ...
    Double getAverageRatingByTimeAndCategory(@Param("startDate") Instant startDate, @Param("endDate") Instant endDate, @Param("category") ActivityCategory category);
    ...
    Double getAverageRatingByTimeAndStatus(@Param("startDate") Instant startDate, @Param("endDate") Instant endDate, @Param("status") ActivityStatus status);
    
    @Query("SELECT AVG(f.rating) FROM EFeedback f JOIN f.activity a WHERE a.activityCategory = :category AND a.status = :status")
    Double getAverageRatingByCategoryAndStatus(@Param("category") ActivityCategory category, @Param("status") ActivityStatus status);
    ...
    Double getAverageRatingByTimeAndCategoryAndStatus(@Param("startDate") Instant startDate, @Param("endDate") Instant endDate, @Param("category") ActivityCategory category, @Param("status") ActivityStatus status);
    ...
    Long countReviewsByTimeAndCategory(@Param("startDate") Instant startDate, @Param("endDate") Instant endDate, @Param("category") ActivityCategory category);
    ...
    Long countReviewsByTimeAndStatus(@Param("startDate") Instant startDate, @Param("endDate") Instant endDate, @Param("status") ActivityStatus status);
    
    @Query("SELECT COUNT(f) FROM EFeedback f JOIN f.activity a WHERE a.activityCategory = :category AND a.status = :status")
    Long countReviewsByCategoryAndStatus(@Param("category") ActivityCategory category, @Param("status") ActivityStatus status);
    ...
    Long countReviewsByTimeAndCategoryAndStatus(@Param("startDate") Instant startDate, @Param("endDate") Instant endDate, @Param("category") ActivityCategory category, @Param("status") ActivityStatus status);
    ...
    List<String> getFeedbackDescriptionsInTimeRange(@Param("startDate") Instant startDate, @Param("endDate") Instant endDate);
    ...
    List<String> getFeedbackDescriptionsByTimeAndCategory(@Param("startDate") Instant startDate, @Param("endDate") Instant endDate, @Param("category") ActivityCategory category);
    ...
    List<String> getFeedbackDescriptionsByTimeAndStatus(@Param("startDate") Instant startDate, @Param("endDate") Instant endDate, @Param("status") ActivityStatus status);
    ...
    List<String> getFeedbackDescriptionsByCategoryAndStatus(@Param("category") ActivityCategory category, @Param("status") ActivityStatus status);
    ...
    List<String> getFeedbackDescriptionsByTimeAndCategoryAndStatus(@Param("startDate") Instant startDate, @Param("endDate") Instant endDate, @Param("category") ActivityCategory category, @Param("status") ActivityStatus status);
}

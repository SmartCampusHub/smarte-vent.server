...
public interface ActivityRepository extends JpaRepository<EActivity, Long>, JpaSpecificationExecutor<EActivity> {
  ...
  Long countActivitiesByTimeAndCategory(@Param("startDate") Instant startDate, @Param("endDate") Instant endDate, @Param("category") ActivityCategory category);
  
  @Query("SELECT COUNT(a) FROM EActivity a WHERE a.startDate BETWEEN :startDate AND :endDate AND a.status = :status")
  Long countActivitiesByTimeAndStatus(@Param("startDate") Instant startDate, @Param("endDate") Instant endDate, @Param("status") ActivityStatus status);
  ...
  Long countActivitiesByCategoryAndStatus(@Param("category") ActivityCategory category, @Param("status") ActivityStatus status);
  ...
  Long countActivitiesByTimeAndCategoryAndStatus(@Param("startDate") Instant startDate, @Param("endDate") Instant endDate, @Param("category") ActivityCategory category, @Param("status") ActivityStatus status);
  ...
  List<Object[]> countActivitiesByCategoryInTimeRange(@Param("startDate") Instant startDate, @Param("endDate") Instant endDate);
  ...
  List<Object[]> countActivitiesByStatusInTimeRange(@Param("startDate") Instant startDate, @Param("endDate") Instant endDate);
  ...
  Long countParticipantsByTimeAndCategory(@Param("startDate") Instant startDate, @Param("endDate") Instant endDate, @Param("category") ActivityCategory category);
  ...
  Long countParticipantsByTimeAndStatus(@Param("startDate") Instant startDate, @Param("endDate") Instant endDate, @Param("status") ActivityStatus status);
  
  @Query("SELECT SUM(a.currentParticipants) FROM EActivity a WHERE a.activityCategory = :category AND a.status = :status")
  Long countParticipantsByCategoryAndStatus(@Param("category") ActivityCategory category, @Param("status") ActivityStatus status);
  ...
  Long countParticipantsByTimeAndCategoryAndStatus(@Param("startDate") Instant startDate, @Param("endDate") Instant endDate, @Param("category") ActivityCategory category, @Param("status") ActivityStatus status);
  ...
  // Calculate participation rate (% of available slots filled) for an organization

...
public interface OrganizationStatisticsService {
   ...
   * @return OrganizationStatisticsVm containing filtered statistics for the
   *         organization
   */
   ...
   * 
   * @param organizationId The ID of the organization
   * @return OrganizationStatisticsVm containing daily statistics for the
   *         organization
   */
   ...
   * 
   * @param organizationId The ID of the organization
   * @return OrganizationStatisticsVm containing weekly statistics for the
   *         organization
   */
   ...
   * 
   * @param organizationId The ID of the organization
   * @return OrganizationStatisticsVm containing monthly statistics for the
   *         organization
   */
   ...
   * 
   * @param organizationId The ID of the organization
   * @return OrganizationStatisticsVm containing quarterly statistics for the
   *         organization
   */
   ...
   * 
   * @param organizationId The ID of the organization
   * @return OrganizationStatisticsVm containing yearly statistics for the
   *         organization
   */
  OrganizationStatisticsVm getYearlyOrganizationStatistics(Long organizationId);

  /**
   * Get organization statistics for a specific organization within a custom date
   * range
   * 
   * @param organizationId The ID of the organization
   ...
   *         in the date range
   */
  OrganizationStatisticsVm getOrganizationStatisticsInDateRange(Long organizationId, Instant startDate,
      Instant endDate);
}
